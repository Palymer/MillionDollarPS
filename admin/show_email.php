...
<table border="1" id="table1" width="600">
    ...
    <tr>
        <td width="118"> Сообщение (HTML)</td>
        <td width="322"></td>
    </tr>
    <tr>
